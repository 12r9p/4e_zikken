...
図 @fig-bode より、位相差は 3.30 kHz で 0° となり、帰還率はこの近傍で最大となった。設計値 $f_0=3.34 "kHz"$ に対して、位相差が 0° となった実測周波数は 3.30 kHz であった。したがって誤差率は 1.2 % である。なお、離散的な測定点の中で最大帰還率 $beta=0.324$ が得られたのは 3.4 kHz であった。
近傍の測定分解能および電圧読取りのばらつきによる差とみなせる。



表 6 より、2 回の測定でともに 3.33 kHz の発振を得た。設計値 3.34 kHz に対する誤差率は 0.30 % である。測定した増幅率は $A=3.04$、帰還率は $beta=0.323$ であり、
