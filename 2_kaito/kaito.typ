...
/*ここの説明について、チャットに添付した画像のような流れで説明をしたい*/
...
である。したがって、表 7 の発振開始周波数 3.33 kHz に対する誤差率は、
...
$ A = 1 + R_4 / R_3 = 1 + R_2 / R_1 + C_1 / C_2 $

$ = 1 + 0.992 / 1.01 + 48.7 / 46.7 = 3.03 $
...
表 7 より、2 回の測定でともに 3.33 kHz の発振を得た。理論値 3.34 kHz に対する誤差率は 0.30 % である。

また、測定した帰還率 $beta=0.323$ より、
