...
#ifndef SPECTROGRAMAPP_SWIFT_H
#define SPECTROGRAMAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpectrogramApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14SpectrogramApp11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC14SpectrogramApp14ViewController")
