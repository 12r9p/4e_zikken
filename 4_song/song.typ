...
#align(center)[
  #figure_report(path: "3-1/3-1_1ph_half_cap_ac.jpg", caption: "単相半波整流波形（Cあり AC結合, V_in = 40 V）")
]
...
#align(center)[
  #figure_report(path: "3-2/3-2_1ph_bridge_cap_ac.jpg", caption: "単相ブリッジ整流波形（Cあり AC結合, V_in = 40 V）")
]
...
#align(center)[
  #figure_report(path: "3-3/3-3_3ph_half_cap_ac.jpg", caption: "三相半波整流波形（Cあり AC結合, V_in = 40 V）")
]
...
#align(center)[
  #figure_report(path: "3-5/3-5_circuit.jpeg", caption: "サイリスタ半波整流回路の実験回路図")
]
...
#align(center)[
  #figure_report(path: "3-5/3-5_1ph_half_thy_120deg.jpg", caption: "サイリスタ半波整流波形（α = 120°, V_in = 40 V）")
]
...
#align(center)[
  #figure_report(path: "3-6/3-6_circuit.jpeg", caption: "混合ブリッジ整流回路の実験回路図")
]
...
#align(center)[
  #figure_report(path: "3-6/3-6_1ph_bridge_thy_120deg.jpg", caption: "混合ブリッジ整流波形（α = 120°, V_in = 40 V）")
]
...
- *実効値 $V_r$*：
  $
    V_r = sqrt(3 / (2 pi) integral_(-pi/3)^(pi/3) (sqrt(2) V_p cos theta)^2 d theta) = sqrt((3 V_p^2) / pi integral_(-pi/3)^(pi/3) (1 + cos 2theta) / 2 d theta) \\
    = sqrt((3 V_p^2) / pi [theta / 2 + (sin 2theta) / 4]_(-pi/3)^(pi/3)) = sqrt((3 V_p^2) / pi ( pi / 6 + sqrt(3) / 8 - (-pi / 6 - sqrt(3) / 8) )) \\
    = sqrt((3 V_p^2) / pi ( pi / 3 + sqrt(3) / 4 )) = V_p sqrt(1 + (3 sqrt(3)) / (4 pi)) \\
    = (V_L / sqrt(3)) sqrt(1 + (3 sqrt(3)) / (4 pi)) = sqrt(1 / 3 + sqrt(3) / (4 pi)) V_L
  $
...
- *実効値 $V_r$*：
  $
    V_r = sqrt(3 / pi integral_(-pi/6)^(pi/6) (sqrt(2) V_L cos theta)^2 d theta) = sqrt((6 V_L^2) / pi integral_(-pi/6)^(pi/6) (1 + cos 2theta) / 2 d theta) \\
    = sqrt((6 V_L^2) / pi [theta / 2 + (sin 2theta) / 4]_(-pi/6)^(pi/6)) = sqrt((6 V_L^2) / pi ( pi / 12 + sqrt(3) / 8 - (-pi / 12 - sqrt(3) / 8) )) \\
    = sqrt((6 V_L^2) / pi ( pi / 6 + sqrt(3) / 4 )) = V_L sqrt(1 + (3 sqrt(3)) / (2 pi))
  $
...
- *実効値 $V_r$*：
  $
    V_r = sqrt(1 / (2 pi) integral_alpha^pi (sqrt(2) V sin theta)^2 d theta) = sqrt(V^2 / pi integral_alpha^pi (1 - cos 2theta) / 2 d theta) = sqrt(V^2 / (2 pi) [theta - (sin 2theta) / 2]_alpha^pi) = sqrt(V^2 / (2 pi) (pi - alpha + (sin 2alpha) / 2)) = sqrt((pi - alpha + (sin 2alpha) / 2) / (2 pi)) V
  $
...
- *実効値 $V_r$*：
  $
    V_r = sqrt(1 / pi integral_alpha^pi (sqrt(2) V sin theta)^2 d theta) = sqrt((2 V^2) / pi integral_alpha^pi (1 - cos 2theta) / 2 d theta) = sqrt(V^2 / pi [theta - (sin 2theta) / 2]_alpha^pi) = sqrt((pi - alpha + (sin 2alpha) / 2) / pi) V
  $
